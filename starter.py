...
colors = ['blue', 'black', 'green', 'jade', 'red']
...
# between 70 and 79, 'C', between 60 and 69, 
...
# Problem 12
# Research to find the Python method that allows, 
# you to add an element to the end of the array 
